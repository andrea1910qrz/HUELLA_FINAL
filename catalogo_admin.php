...
<meta charset="utf-8">
<title>Huella | Catalogo Administracion</title>
<style>
...
<!-- Navbar principal -->
     ...
     <nav class="nav-links">
      ...
      <a href="Nosotros_admin.html">Sobre Nosotros</a>
...
<i class="titulo_coleccion">Bienvenido a Administración. </i>

<a href="agregar_producto.html" class="btn_agregar">Agregar Producto</a>
...
<?php if (count($productos) > 0): ?>
    <?php foreach ($productos as $p): ?>
        ...
        <div class="producto">
           ...
           <a href="editar_coleccion.php?id=<?php echo $p['id_producto']; ?>">
            <button class="btn_coleccion">Editar</button>
          </a>
          <a href="eliminar_coleccion.php?id=<?php echo $p['id_producto']; ?>">
            <button class="btn_coleccion">Eliminar</button>
          </a>
        </div>
    <?php endforeach; ?>
<?php else: ?>
