...
<body>
    <style>
        body{
          background-color: #b12755ff;
          background-image: url("imagenes/editar_prod.jpg");
          background-size: 40%;
...
<div class="contenedor_formulario">
   <form action="actualizar_coleccion.php" method="POST">
    ...
    <button class="btn_editar" type="submit">Guardar cambios</button>
